...
combined[7]
combined [5:8]
c(combined[1:3], combined[(length(combined)-2):length(combined)])
...
```{r}
roll_15_winner <- function(name1, name2){
  p1 <- sample(1:6, 15, replace = TRUE)
  p2 <- sample(1:6, 15, replace = TRUE)
  p1_wins <- p1 > p2
  p2_wins <- p2 > p1
  ties <- p1 == p2
  cat("p1 wins:", sum(p1_wins), "\n")
  cat("p2 wins:", sum(p2_wins), "\n")
  cat("Ties:", sum(ties), "\n")
...
cheating_roll_15 <- function(name1, name2){
  p1 <- sample(1:6, 15, replace = TRUE, prob = c(1,1,2,2,3,3))
  p2 <- sample(1:6, 15, replace = TRUE)
  p1_wins <- p1 > p2
  p2_wins <- p2 > p1
  if (sum(p1_wins) > sum(p2_wins)) {
